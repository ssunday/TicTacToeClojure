...
(defn- assign-scores-to-available-locations [board player-markers]
  (zipmap (get-available-locations board)
          (scores-for-available-locations board player-markers)))

(defn- get-best-move [board player-markers]
  (key (apply max-key val (assign-scores-to-available-locations board player-markers))))

(defn best-move [board ai-marker opponent-marker]
  (get-best-move board (player-markers ai-marker opponent-marker)))
